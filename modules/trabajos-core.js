...
(function(){
  ...
  function inferSubject(groupId,subjectId){const grade=groupGrade(groupId);if(subjectId&&window.PD_CONFIG?.subjectAllowed(subjectId,grade))return subjectId;if(grade==='2'||grade==='3')return 'vida23';return subjectId||null}
